...
- Clone the forked repository to your local development machine
  (e.g. `git clone git@github.com:<YOUR_GITHUB_USER>/pure_dart_ui.git`).
...
Go to the [pull request page of PureDartUI][PRs] and in the top
...
[GitHub issue]: https://github.com/signmotion/pure_dart_ui/issues/new
[GitHub issues]: https://github.com/signmotion/pure_dart_ui/issues/new
[PRs]: https://github.com/signmotion/pure_dart_ui/pulls
